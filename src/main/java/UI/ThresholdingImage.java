 ...
 * @author raulv
 */
public class ThresholdingImage extends javax.swing.JFrame {
    ...
    /**
     * Creates new form ThresholdingImage
     */
    ...
    private void initComponents() {
        ...
        saveItem.setAccelerator(javax.swing.KeyStroke.getKeyStroke(java.awt.event.KeyEvent.VK_S, java.awt.event.InputEvent.ALT_DOWN_MASK));
    ...
    private void thresholdImageActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_thresholdImageActionPerformed
        if(imagen!=null){
            ...
            if(Integer.parseInt(input) >= 1 && Integer.parseInt(input) <= 255){
                ...
                thresholdedImage = lienzo1.umbralizar(originalImage, Integer.parseInt(input));
                BufferedImage thresholdingImag = (BufferedImage) HighGui.toBufferedImage(thresholdedImage);
                lienzo1.drawImage(thresholdingImag);
            } else {
    ...
    private void saveItemActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_saveItemActionPerformed
        ...
        if (res==JFileChooser.APPROVE_OPTION){
            ...
            int res2 = JOptionPane.showConfirmDialog(rootPane, "Are you sure you "
            + "want to save the image?", "Save image", JOptionPane.YES_OPTION);
            if(res2 == JOptionPane.YES_OPTION){
                String imageSave = fc.getCurrentDirectory()+"\\" + imagen.getName();
                try {
                    ImageIO.write(lienzo1.getImagen(), "jpg", new File(imageSave));
                } catch (IOException ex) {
                    Logger.getLogger(ThresholdingImage.class.getName()).log(Level.SEVERE, null, ex);
                }
            }
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ThresholdingImage.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ThresholdingImage().setVisible(true);
            }
        });
    }
